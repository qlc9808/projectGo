  ...
  <form action="FAQUpdate" method="post">
    ...
    <div class="container main-container">
      ...
      <div class="post-controls">
        ...
        <button type="button" class="btn btn-primary2" onclick="location.href='/admin/board/FAQUpdateForm?id=${board.id}&currentPage=${currentPage}'">수정하기</button>
        <button type="button" class="btn btn-danger" onclick="deleteFAQ('${board.id}', '${currentPage}')">삭제</button>
      </div>
    </div>
  </form>
